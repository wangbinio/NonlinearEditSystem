...
namespace vlc.net
{
    internal class VlcPlayer
    {
        ...
        {
            var plugin_arg = "--plugin-path=" + pluginPath;
        ...
        {
            var libvlc_media = LibVlcAPI.libvlc_media_new_path(libvlc_instance_, filePath);
        ...
        {
            LibVlcAPI.libvlc_media_player_set_time(libvlc_media_player_, (long) (seekTime*1000));
        }
    ...
    internal static class LibVlcAPI
    {
        ...
        {
            var argv = new PointerToArrayOfPointerHelper();
            ...
            try
            {
                var size = Marshal.SizeOf(typeof(PointerToArrayOfPointerHelper));
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        public static extern void libvlc_media_player_set_hwnd(IntPtr libvlc_mediaplayer, int drawable);
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        public static extern long libvlc_media_get_duration(IntPtr libvlc_media);

        // 当前播放的时间
        [DllImport("libvlc", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        public static extern long libvlc_media_player_get_time(IntPtr libvlc_mediaplayer);

        // 设置播放位置(拖动)
        [DllImport("libvlc", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        public static extern void libvlc_media_player_set_time(IntPtr libvlc_mediaplayer, long time);
        ...
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 11)] public IntPtr[] pointers;
        }
    }
}